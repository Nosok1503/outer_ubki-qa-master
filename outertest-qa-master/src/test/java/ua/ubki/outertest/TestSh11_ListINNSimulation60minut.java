...
public class TestSh11_ListINNSimulation60minut extends Simulation {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestSh11_ListINNSimulation60minut.class);
...
//Запит №4 Шаблон 11
                            ...
                            .exec(http("Check B2 Shablon 11 for INN4")
                                    ...
                                    .transformResponse((response, session) -> {
                                        ...
                                        LOGGER.info("requestTime4: {}", requestTime4);
                            ...
                            .exec(session -> {
                                LOGGER.info("varresponseTime4 > maxDelayTime11Sh||requestError4 : {} ", varresponseTime4 > maxDelayTime11Sh || requestError4);
                                    ...
                                    exec(session -> session.set("inn", "**RANDOM**"))
                                            .exec(http("Check B2 Shablon 11 for INN5")
                                                    ...
                                                    .transformResponse((response, session) -> {
                                                        ...
                                                        LOGGER.info("requestTime5: {}", requestTime5);
                                            ...
                                            .exec(session -> {
                                                LOGGER.info("varresponseTime5 > maxDelayTime11Sh || requestError5: {} ", varresponseTime5 > maxDelayTime11Sh || requestError5);
...
//Запит №6  Шаблон 11
                                    exec(session -> session.set("inn", "**RANDOM**"))
                                            .exec(http("Check B2 Shablon 11 for INN6")
                                                    ...
                                                    .transformResponse((response, session) -> {
                                                        ...
                                                        LOGGER.info("requestTime6: {}", requestTime6);
                            ...
                            .exec(session -> {
                                LOGGER.info("pause: {} ", 60 - ChronoUnit.SECONDS.between(TestBeginTime, LocalDateTime.now()));
                                return session;
                            })
                    //   .pace(60)
                    //.pause( 60- ChronoUnit.SECONDS.between(TestBeginTime, LocalDateTime.now()))
...

    {
        setUp(authScn.injectOpen(atOnceUsers(1)).protocols()
                        .andThen(CheckB2Shablon11ForListINN60minut.injectOpen(atOnceUsers(1)).protocols(httpProtocolB2)
